    ...
    public partial class usersignup : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            if (checkMemberExists())
            {
                ...
                Response.Write("<script>alert('Пользователь с таким идентификатором существует, попробуй другой идентификатор!');</script>");
            }
            else
            {
                signUpNewMember();
        ...
        void signUpNewMember()
        {
            try
            {
                ...
                cmd.ExecuteNonQuery();
                con.Close();
                Response.Write("<script>alert('Регистрация прошла успешно!. Перейдите в раздел Логин для входа в систему');</script>");
